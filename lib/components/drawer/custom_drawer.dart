      ...
      child: ListView(
        children: [
         SizedBox(
          ...
          _menuItems(context, "Profil", _iconSvg("assets/icons/twitter-profile.svg")),
          _menuItems(context, "Premium",  Icon(FontAwesomeIcons.circleCheck,color: ColorConstant.instance.tertiaryColor,)),
          _menuItems(context, "Listeler",  _iconSvg("assets/icons/twitter-lists.svg")),
          _menuItems(context, "Yer İşaretleri",  Icon(FontAwesomeIcons.bookmark,color: ColorConstant.instance.tertiaryColor,)),
          _menuItems(context, "Onaylı Kuruluşlar", Icon(FontAwesomeIcons.bolt,color: ColorConstant.instance.tertiaryColor,)),
          _menuItems(context, "Para Kazanma", Icon(FontAwesomeIcons.moneyBill1,color: ColorConstant.instance.tertiaryColor,)),
          _menuItems(context, "Reklamlar", Icon(FontAwesomeIcons.arrowUpRightFromSquare,color: ColorConstant.instance.tertiaryColor,)),
          _menuItems(context, "İşler", Icon(Icons.work_history_outlined,color: ColorConstant.instance.tertiaryColor,weight: 20,)),
          _menuItems(context, "Ayarlar ve Gizlilik",  _iconSvg("assets/icons/twitter-settings.svg")),
